...
class TBSmoothScrollLayout: UICollectionViewLayout {
    ...
    private func registerDecorationViews() {
        register(ShadowDecoration.self, forDecorationViewOfKind: TBSmoothScrollLayout.kCBAnimatedLayoutMenuShadow)
        register(SeparatorDecoration.self, forDecorationViewOfKind: TBSmoothScrollLayout.kCBAnimatedLayoutHorSeparator)
        register(SeparatorDecoration.self, forDecorationViewOfKind: TBSmoothScrollLayout.kCBAnimatedLayoutVertSeparator)
    }
